...
import { legacyGeminiClient as geminiClient } from './GeminiClientLegacy.js'
import { ASSET_SYSTEM_PROMPT_V4_BRIGHT, PLANNING_SYSTEM_PROMPT_V4, CATEGORY_PALETTES, CATEGORY_PROPORTIONS } from './systemPromptsLegacy.js'
import { assertCodeSafety } from '../CodeSandbox.js'
import { assertDelimiterBalance, validateDelimiterBalance } from '../syntaxValidator.js'
...
- Example black cat: [0x2F2F2F, 0x808080, 0xFFFF00] (dark gray, not pure black!)`
    ...
    return { asset, code, quality, compiledSuccessfully, postProcessAdjustments }
  }
...
// Singleton instance
export const legacyAssetGenerator = new AssetGenerator()
